...
class MySpider(Spider):
    ...
    def parse(self, response):
        ...
        #if has to click to go to the next page

        # next_page = 'https://www.decolar.com/shop/flights/search/roundtrip/GRU/FOR/2019-09-30/2019-10-07/1/0/0/NA/NA/NA/NA/NA/?from=SB&di=1-0'
        #
